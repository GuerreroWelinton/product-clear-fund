# Plan técnico - F07 Adelanto de cuotas de ahorro

## Diseño propuesto

Implementar la feature dentro de `src/modules/savings-prepayments` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- `previewSavingsPrepayment`
- `createFutureSavingsObligations`
...
- Selector de meses futuros permitido.
- Indicador del límite disponible.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F07`.
