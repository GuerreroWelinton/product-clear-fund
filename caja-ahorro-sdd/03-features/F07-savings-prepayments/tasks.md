# Tareas - F07 Adelanto de cuotas de ahorro

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F07-*`.
- [ ] Confirmar dependencias: F06, F08.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: SavingsObligation, PaymentAllocation.
