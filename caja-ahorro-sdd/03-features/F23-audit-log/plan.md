# Plan técnico - F23 Auditoría transversal

## Diseño propuesto

Implementar la feature dentro de `src/modules/audit-log` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F23`.
