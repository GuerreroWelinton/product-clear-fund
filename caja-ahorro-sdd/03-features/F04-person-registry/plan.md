# Plan técnico - F04 Registro único de personas

## Diseño propuesto

Implementar la feature dentro de `src/modules/person-registry` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Historial resumido de cajas y números.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F04`.
