# Tareas - F12 Rondas y turnos de préstamo

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F12-*`.
- [ ] Confirmar dependencias: F05, F10, F11.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: LoanRound, LoanTurn.
