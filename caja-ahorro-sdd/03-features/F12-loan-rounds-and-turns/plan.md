# Plan técnico - F12 Rondas y turnos de préstamo

## Diseño propuesto

Implementar la feature dentro de `src/modules/loan-rounds-and-turns` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Vista de ronda.
- Top cinco elegibles.
- Acciones posponer, reactivar y cerrar.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F12`.
