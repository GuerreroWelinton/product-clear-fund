# Tareas - F09 Reversas parciales

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F09-*`.
- [ ] Confirmar dependencias: F08, F20, F23.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: PaymentAllocationReversal, CashMovement, AuditEvent.
