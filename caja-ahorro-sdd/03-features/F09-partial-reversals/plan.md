# Plan técnico - F09 Reversas parciales

## Diseño propuesto

Implementar la feature dentro de `src/modules/partial-reversals` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F09`.
