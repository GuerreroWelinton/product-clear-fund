# Plan técnico - F08 Pagos agrupados y asignaciones

## Diseño propuesto

Implementar la feature dentro de `src/modules/grouped-payments` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Formulario de pago agrupado.
- Resumen y total en tiempo real.
...
- Errores con códigos estables prefijados por `F08`.
