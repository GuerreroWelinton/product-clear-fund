# Tareas - F08 Pagos agrupados y asignaciones

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F08-*`.
- [ ] Confirmar dependencias: F06, F20, F23.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: Payment, PaymentAllocation, CashMovement.
