# Tareas - F05 Alta de números e igualación

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F05-*`.
- [ ] Confirmar dependencias: F04, F20, F23.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: MembershipOnboarding, Membership, CashMovement.
