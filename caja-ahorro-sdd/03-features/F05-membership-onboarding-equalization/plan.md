# Plan técnico - F05 Alta de números e igualación

## Diseño propuesto

Implementar la feature dentro de `src/modules/membership-onboarding-equalization` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Calculadora de igualación.
- Confirmación de pago y alta.
- Detalle del número creado.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F05`.
