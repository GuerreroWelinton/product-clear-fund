# Criterios de aceptación - F02 Ciclo de vida y configuración de cajas

## Escenarios obligatorios

### AC-F02-001

**Escenario:** Dada una caja activa con números, cuando se intenta cambiar la cuota fija, entonces la operación es rechazada.
