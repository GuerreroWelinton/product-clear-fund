# Tareas - F13 Asignación de préstamo

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F13-*`.
- [ ] Confirmar dependencias: F10, F11, F12.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: Loan, LoanTurn, RiskOverride.
