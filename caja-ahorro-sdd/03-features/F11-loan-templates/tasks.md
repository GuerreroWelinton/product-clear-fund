# Tareas - F11 Plantillas de préstamo

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F11-*`.
- [ ] Confirmar dependencias: F02, F23.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: LoanTemplate, LoanTemplateCapitalSegment.
