# Plan técnico - F11 Plantillas de préstamo

## Diseño propuesto

Implementar la feature dentro de `src/modules/loan-templates` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.

## Modelo de datos

- LoanTemplate
- LoanTemplateCapitalSegment
...
- `createLoanTemplate`
- `updateLoanTemplateDraft`
- `validateLoanTemplate`
- `activateLoanTemplate`
- `deactivateLoanTemplate`
- `reactivateLoanTemplate`
- `duplicateLoanTemplate`
...
- Editor de plantilla.
- Validador de tramos.
- Duplicar, activar, desactivar y reactivar.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F11`.
