# Plan técnico - F03 Asignación de tesoreros

## Diseño propuesto

Implementar la feature dentro de `src/modules/treasurer-assignments` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Selector de cajas asignadas.
- Gestión de asignaciones en detalle de caja.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F03`.
