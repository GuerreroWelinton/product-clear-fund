...
- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F01-*`.
- [ ] Confirmar dependencias: Ninguna.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: User, Session, Account.
