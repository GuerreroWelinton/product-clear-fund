# Plan técnico - F01 Autenticación y sesiones

## Diseño propuesto

Implementar la feature dentro de `src/modules/auth-and-sessions` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Acción para revocar sesiones.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F01`.
