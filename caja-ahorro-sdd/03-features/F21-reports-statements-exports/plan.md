# Plan técnico - F21 Reportes, estados de cuenta y exportaciones

## Diseño propuesto

Implementar la feature dentro de `src/modules/reports-statements-exports` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F21`.
