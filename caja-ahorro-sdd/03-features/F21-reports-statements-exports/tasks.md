# Tareas - F21 Reportes, estados de cuenta y exportaciones

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F21-*`.
- [ ] Confirmar dependencias: F06, F08, F10, F15, F18, F19, F20.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: Proyecciones de lectura, sin nueva entidad obligatoria..
