# Tareas - F17 Registro y reversa de gastos

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F17-*`.
- [ ] Confirmar dependencias: F20, F23.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: Expense, CashMovement.
