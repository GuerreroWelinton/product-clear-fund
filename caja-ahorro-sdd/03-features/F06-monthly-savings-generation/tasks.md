# Tareas - F06 Generación mensual de cuotas de ahorro

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F06-*`.
- [ ] Confirmar dependencias: F02, F05, F24.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: SavingsObligation.
