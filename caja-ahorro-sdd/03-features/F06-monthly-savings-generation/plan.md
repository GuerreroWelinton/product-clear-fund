# Plan técnico - F06 Generación mensual de cuotas de ahorro

## Diseño propuesto

Implementar la feature dentro de `src/modules/monthly-savings-generation` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Listado mensual de obligaciones.
...
- Errores con códigos estables prefijados por `F06`.
