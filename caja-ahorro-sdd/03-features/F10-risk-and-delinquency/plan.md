# Plan técnico - F10 Morosidad, semáforo y riesgo

## Diseño propuesto

Implementar la feature dentro de `src/modules/risk-and-delinquency` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F10`.
