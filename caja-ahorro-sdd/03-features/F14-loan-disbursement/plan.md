# Plan técnico - F14 Desembolso y saldo comprometido

## Diseño propuesto

Implementar la feature dentro de `src/modules/loan-disbursement` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Contadores de saldo contable, comprometido y libre.
- Confirmar/cancelar.
...
- Errores con códigos estables prefijados por `F14`.
