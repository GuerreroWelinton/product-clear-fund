# Tareas - F14 Desembolso y saldo comprometido

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F14-*`.
- [ ] Confirmar dependencias: F13, F20.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: Loan, CashMovement, LoanTurn.
