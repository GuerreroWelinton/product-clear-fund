# Plan técnico - F22 Migración inicial y saldos de apertura

## Diseño propuesto

Implementar la feature dentro de `src/modules/opening-migration` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F22`.
