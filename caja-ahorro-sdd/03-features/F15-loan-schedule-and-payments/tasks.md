# Tareas - F15 Cronograma y pagos de préstamo

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F15-*`.
- [ ] Confirmar dependencias: F08, F11, F14.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: LoanInstallment, PaymentAllocation.
