# Plan técnico - F15 Cronograma y pagos de préstamo

## Diseño propuesto

Implementar la feature dentro de `src/modules/loan-schedule-and-payments` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Selector de cuotas.
- Resumen capital/interés.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F15`.
