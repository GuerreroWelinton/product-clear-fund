# Plan técnico - F18 Cierre y distribución de rendimientos

## Diseño propuesto

Implementar la feature dentro de `src/modules/annual-closing-distribution` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- `previewAnnualClosing`
- `confirmAnnualClosing`
- `listClosingAdjustments`
...
- Detalle de intereses, gastos, déficit y remanente.
- Asignaciones por número.

## Contratos

- Entradas validadas con schemas.
- Montos transmitidos como decimal string.
- Errores con códigos estables prefijados por `F18`.
