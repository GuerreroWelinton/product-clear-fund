# Tareas - F18 Cierre y distribución de rendimientos

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F18-*`.
- [ ] Confirmar dependencias: F08, F09, F17, F20.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: AnnualClosing, ParticipationPeriod, DistributionAllocation, CashMovement.
