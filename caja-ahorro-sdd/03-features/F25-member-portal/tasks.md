# Tareas - F25 Portal futuro del socio

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F25-*`.
- [ ] Confirmar dependencias: F04, F05, F06, F08, F15, F18, F19, F21.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: UserPersonLink.
