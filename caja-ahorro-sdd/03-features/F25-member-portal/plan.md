# Plan técnico - F25 Portal futuro del socio

## Diseño propuesto

Implementar la feature dentro de `src/modules/member-portal` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F25`.
