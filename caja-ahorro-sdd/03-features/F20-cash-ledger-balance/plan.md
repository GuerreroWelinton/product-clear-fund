# Plan técnico - F20 Libro de caja y saldos

## Diseño propuesto

Implementar la feature dentro de `src/modules/cash-ledger-balance` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Libro cronológico.
- Tarjetas de saldo contable, comprometido y libre.
- Filtros.
...
- Errores con códigos estables prefijados por `F20`.
