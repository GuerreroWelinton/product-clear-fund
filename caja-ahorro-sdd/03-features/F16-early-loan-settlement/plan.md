# Plan técnico - F16 Liquidación anticipada

## Diseño propuesto

Implementar la feature dentro de `src/modules/early-loan-settlement` siguiendo las capas `domain`, `application`, `infrastructure`, `schemas` y `ui`.
...
- Errores con códigos estables prefijados por `F16`.
