# Tareas - F16 Liquidación anticipada

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F16-*`.
- [ ] Confirmar dependencias: F15.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: LoanSettlement, Loan, LoanInstallment, CashMovement.
