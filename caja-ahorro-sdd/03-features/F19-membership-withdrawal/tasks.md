# Tareas - F19 Retiro y liquidación de un número

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F19-*`.
- [ ] Confirmar dependencias: F05, F09, F16, F18, F20.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: MembershipWithdrawal, Membership, CashMovement.
