# Tareas - F24 Procesos automáticos e idempotencia

## 1. Preparación

- [ ] Revisar `spec.md` y resolver contradicciones. Implementa todos los requisitos `FR-F24-*`.
- [ ] Confirmar dependencias: F02, F06, F10.
- [ ] Diseñar DTOs y códigos de error.
- [ ] Actualizar la matriz de trazabilidad.

## 2. Base de datos

- [ ] Agregar o ajustar entidades: JobExecution.
